...
export function SettingsPage() {
  ...
  useEffect(() => { Promise.all([api<AppConfig>('/api/config'), fetch('/health').then((response) => response.json())]).then(([configResult, healthResult]) => { setConfig(configResult); setHealth(healthResult); }); }, []);
